...
#include <vector>
#include <glew.h> // O <glad/glad.h> dependiendo de qué uses en tu curso
...
protected: // Cambiado a protected para que MeshColor pueda verlos si hereda, o déjalos en private
