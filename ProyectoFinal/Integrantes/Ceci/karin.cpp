...
void Karin::Initialize()
{
	if (initialized) return;

	cuerpoModel.LoadModel("Models/karin_cuerpo.obj");
	cabezaModel.LoadModel("Models/karin_cabeza.obj");
	brazoDerModel.LoadModel("Models/karin_brazo_der.obj");
	brazoIzqModel.LoadModel("Models/karin_brazo_izq.obj");

	material = Material(0.3f, 4);

	// Orilla trasera del escenario (mismo Y que miku)
	position  = glm::vec3(77.54f, -0.92f, 9.75f);
...
void Karin::Render(GLuint uniformModel, GLuint uniformColor,
